...
func (k *Key) String() string {
	...
	builder.WriteString("(")
	builder.WriteString(k.Columns.String())
	builder.WriteString(")")
	return builder.String()
}

func (k *Key) Accept(visitor ASTVisitor) error {
	return visitor.VisitKey(k)
}
...
func (t *TableOption) String() string {
	var builder strings.Builder
	if t.Name != nil {
...
func (t *TableOption) Accept(visitor ASTVisitor) error {
	visitor.Enter(t)
	defer visitor.Leave(t)
	...
	if t.Value != nil {
		if err := t.Value.Accept(visitor); err != nil {
			return err
		}
	}
	return visitor.VisitTableOption(t)
}
...
func (c *CreateTable) String() string {
	...
	for _, opt := range c.TableOptions {
		builder.WriteString(" ")
...
func (c *CreateTable) Accept(visitor ASTVisitor) error {
	...
	for _, opt := range c.TableOptions {
		if err := opt.Accept(visitor); err != nil {
			return err
		}
	}
	if c.SubQuery != nil {
...
func (c *ColumnDef) String() string {
	...
	if c.OnUpdate != nil {
		...
		builder.WriteString(c.OnUpdate.String())
	}
	if c.NotNull != nil {
