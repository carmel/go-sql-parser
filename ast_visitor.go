...
type ASTVisitor interface {
	...
	VisitCreateDatabase(c *CreateDatabase) error
	VisitTableOption(t *TableOption) error
	VisitCreateTable(c *CreateTable) error
...
func (v *DefaultASTVisitor) VisitTableOption(t *TableOption) error {
	if v.Visit != nil {
		return v.Visit(t)
	}
	return nil
...
func (v *DefaultASTVisitor) VisitKey(k *Key) error {
	if v.Visit != nil {
		return v.Visit(k)
	}
	return nil
